...
public class verifyCode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           registeredUser user= (registeredUser) session.getAttribute("authcode");
            ...
            String query = "update usercredentials set verificationStatus = ? where email=? ";
            
            java.sql.PreparedStatement pt = con1.prepareStatement(query);
            pt.setInt(1,0);     // 0 to denote verification is done 
